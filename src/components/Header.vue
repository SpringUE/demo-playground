  ...
  <nav>
    ...
    <div flex="~ gap-2" items-center>
      <div v-for="(v, key) of versions" :key="key" flex="~ gap-2" items-center lt-lg-hidden>
        ...
        <el-checkbox v-if="key === 'elementPlus'" v-model="nightly" @change="toggleNightly">
          nightly
        </el-checkbox>
      </div>
      ...
      <div flex="~ gap-4">
        ...
        <button text-lg i-ri-sun-line dark:i-ri-moon-line @click="toggleDark()" />
        <a href="https://github.com/SpringUE/demo-playground" target="_blank">
